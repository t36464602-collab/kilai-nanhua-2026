...
/** 天池山莊 → 天池岔路 */
const TO_FORK = "M 650 191 C 660 182 670 172 678 162 C 683 155 686 148 688 140";

/** 天池岔路 → 奇萊南峰 */
const TO_SOUTH =
  "M 688 140 C 690 128 695 114 697 100 C 699 86 694 76 684 66 C 673 54 661 44 650 32";

/** 天池岔路 → 南華山 */
const TO_NANHUA =
  "M 688 140 C 696 150 706 162 712 178 C 718 194 720 216 719 236 C 718 246 717 252 716 258";

/** 南華山 → 光被八表 */
const TO_MONUMENT =
  "M 716 258 C 712 268 704 282 694 296 C 684 310 672 332 663 348 C 661 353 659 357 658 360";

/** 光被八表 → 天池山莊 */
const BACK_TO_LODGE =
  "M 658 360 C 652 350 648 336 649 318 C 650 296 656 274 662 250 C 667 230 670 210 662 198 C 658 194 654 192 650 191";
...
export const routeArrows: RouteArrow[] = [
  { x: 665, y: 177, angle: -46, day: 1 }, // 天池山莊 → 天池岔路
  { x: 695, y: 82, angle: -112, day: 1 }, // 天池岔路 → 奇萊南峰
  { x: 718, y: 206, angle: 84, day: 1 }, // 天池岔路 → 南華山
  { x: 678, y: 321, angle: 120, day: 1 }, // 南華山 → 光被八表
  { x: 654, y: 285, angle: -78, day: 1 }, // 光被八表 → 天池山莊
];
